...
public class Lesson5_oop {
    ...
    public static void main(String[] args) {
        ...
        persArray[1] = new EmployeeData("Rudenko Ivan", "Engineer", "r_vivan1@mailbox.com",
                "89639007701", 60000, 41);
        persArray[2] = new EmployeeData("Ivanov Alex", "Manager", "AI_box_wrk@mail.ru",
                "89639007702", 50000, 35);
        persArray[3] = new EmployeeData("Mikulin Semen", "System Administrator", "Mikilin_ad@mailbox.com",
                "89639007703", 65000, 34);
        persArray[4] = new EmployeeData("Hlebnikov  Maxim", "Engineer", "Max_bread@mailbox.com",
